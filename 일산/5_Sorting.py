...
input_file = 'E:\\test_백석1동_습도_20230111_20241031.csv'
output_file = 'E:\\테스트_백석1동_습도_20230111_20241031.csv'
...
with open(input_file, mode='r', encoding='utf-8') as infile, open(output_file, mode='w', encoding='utf-8',
    ...
    # 데이터 처리
    for row in reader:
        # 6번째 열 (index 5) 값을 확인하여 매핑된 값으로 바꿈
        if row[6] in value_mapping:
            row[6] = value_mapping[row[6]]
