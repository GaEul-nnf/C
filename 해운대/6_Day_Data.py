...
input_file = 'E:\\DayData_좌제3동_기온_202301_202411.csv'
output_file = 'E:\\final_좌제3동_기온_202301_202411.csv'
...
with open(input_file, mode='r', encoding='utf-8') as infile, open(output_file, mode='w', encoding='utf-8',
    ...
    for row in reader:
        ...
        if len(column_4_value) == 5:
            column_4_value = column_4_value.zfill(6)

        # 6번 열의 값이 앞에, 5번 열의 값이 뒤에 오도록 결합
        new_value = column_5_value + column_4_value
